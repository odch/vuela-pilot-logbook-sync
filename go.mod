module github.com/odch/aircraft-logbook/functions-go/flightsync
...
//replace github.com/odch/go-capzlog => ../../../go-capzlog
//replace github.com/odch/go-mycontrol => ../../../go-mycontrol
